<?php
// ÚNICA MODIFICAÇÃO NESTE ARQUIVO DE TESTES:
// - FOI RETIRADO O @ ANTES DA FUNÇÃO FSOCKOPEN PARA VISUALIZAR OS ERROS NA TELA.
...
******************************************************************************************/
	class http {
		...
		function post( $uri, &$form_data, $follow_redirects = true, $referer = '' ) {
			...
			//exit("aki: " . $this->_response->get_status() . "<br>Uri: " . $uri);
			return $this->_response->get_status();
